...
delitos_2020 <-read.csv(file ="https://raw.githubusercontent.com/vicky-marco/IAUII/main/delitos_2020.csv")

library(readr)
delitos_2020B <- read_csv(file = "https://raw.githubusercontent.com/vicky-marco/IAUII/main/delitos_2020.csv")

library(vroom)
delitos_2020C <- vroom("https://raw.githubusercontent.com/vicky-marco/IAUII/main/delitos_2020.csv", delim = ",")
